function [phih,qh]=solve_1D_LDG(Gauss_coefficient,LDG_matrix,Q_matrix,f_values,h,mid_points,mp,ng)
...
f_values = generate_1D_LDG_vector(f_values,Gauss_coefficient,ng,mp,h,mid_points);
