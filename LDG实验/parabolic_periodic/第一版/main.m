...
for k = 1:3
    ...
    qh_L2_error = evaluate_error_Lnorm('exact_fun_x',2,T_end,uh,ng,mp,h,mid_points);
    qh_Linf_error = evaluate_error_absolute('exact_fun_x',T_end,uh,h,mid_points,ng,mp);
