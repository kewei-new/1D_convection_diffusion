function [phi,E_value] = solve_poisson_1D_FEM(t,mp,ng,P,T,Pb,Tb,Gauss_coefficient,h,mid_points,uh,basis_type)
...
b = generate_1D_vector_FEM(Gauss_coefficient,t,uh,Tb,h,mid_points,mp,ng,basis_type);
% b = zeros(mp*ng+1,1);
%% boundary treatment
boundary_nodes = [1,1;1,Tb(end,end)];
[A,b] = boundary_treatment_FEM(t,boundary_nodes,A,b,Pb);
...
% plot(P(1:ng),E_value(1,2:ng+1),'-o');
% hold on
% plot(P(1:ng),sin(t)*sin(P(1:ng)))
% P
