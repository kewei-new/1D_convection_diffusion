function result = generate_1D_matrix_r(Gauss_coefficient,mp1,mp2,trial_basis_type,trial_derivative,test_basis_type,test_derivative)
...
for i = 0:mp2
    for j = 0:mp1
        for k =1:Gpn
            ...
            *reference_basis(GP_r(k),j,trial_basis_type,trial_derivative)...
