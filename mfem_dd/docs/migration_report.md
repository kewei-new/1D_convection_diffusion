...
PDE solve. The C++ device entry now has a native compact summary backend, but it
does not yet recompute the PN IV/CV/transient experiment from a C++ PDE solver.
